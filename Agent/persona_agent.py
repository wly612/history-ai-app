...
AGENT_API_KEY = os.getenv("AGENT_API_KEY") or os.getenv("GEMINI_API_KEY", "")
AGENT_BASE_URL = (os.getenv("AGENT_BASE_URL") or "https://generativelanguage.googleapis.com/v1beta/openai").rstrip("/")
AGENT_MODEL = os.getenv("AGENT_MODEL") or "gemini-2.5-flash"
...
def main() -> None:
    if not AGENT_API_KEY:
        raise RuntimeError("Missing AGENT_API_KEY or GEMINI_API_KEY")
