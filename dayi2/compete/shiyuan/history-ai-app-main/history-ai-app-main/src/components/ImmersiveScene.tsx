...
const ImmersiveScene: React.FC<ImmersiveSceneProps> = ({ node, onBack, onEnterScene, onStartAssessment }) => {
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button
                  ...
                  className="px-8 py-3 bg-primary-container text-on-primary-container font-headline tracking-widest hover:scale-105 transition-transform"
                >
                  前往题目练习
                </button>
              </div>
